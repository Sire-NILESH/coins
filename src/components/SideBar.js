...
// const navItemJsx = (item) => {
//   return (
//     <a
//       className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform dark:text-gray-400 hover:bg-purple-100 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
//       href="#"
//     >
//       <svg
//         className="w-5 h-5"
